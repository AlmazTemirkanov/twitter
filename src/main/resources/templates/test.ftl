...
<div class="spo__back">
    ...
    <form action="<@hst.link />" method="get">
        <div class="news searchh">
            <div class="col-xs-8">
                ...
                <#else>
                    <input type="search" value="" name="query" class="form-control" placeholder="Поиск по новостям">
                </#if>
            </div>
            <#--  <div class="col-xs-4">
    ...
    <#--<div class="spo spo__style "> -->

    <div class="spo spo__style ">
        <input type="checkbox" id="spo">
        <label for="spo">Доп теги</label>
